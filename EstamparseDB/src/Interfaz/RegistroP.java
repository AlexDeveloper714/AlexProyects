...
public class RegistroP extends javax.swing.JFrame {
    ...
    DatosRegistro ingresosUsuarios = new DatosRegistro();
...
//Guardar Registro
        if (nombre.equals("") || documento.equals("") || usuario.equals("") || contraseña.equals("") || email.equals("")) {
            ...
            if (contraseña.equals(confirmar)) {
                if (!ingresosUsuarios.revisarDatos(usuario)) {
                    ...
                    if (a == JOptionPane.YES_OPTION) {
                        Sies = ingresosUsuarios.registrarUsuarios(nombre, documento, usuario, contraseña, tipoUsuario, email, numeroCuenta);
                        ...
                        if (Sies) {
                            ...
                            JOptionPane.showMessageDialog(null, "Debes digitar número en vez de letras para registrarse como Artista", "ERROR", 2);
                        }
                    }
                } else {
