...
public class CargarEstampaP extends javax.swing.JFrame {
    ...
    public CargarEstampaP() {
        ...
        for (int i = 0; i < DatosEstampa.CategoriasTemp.size(); i++) {
            combTipoEstampa.addItem(DatosEstampa.CategoriasTemp.get(i));
        }
    ...
    private void botonSelecionarArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSelecionarArchivoActionPerformed
        try {
            JOptionPane.showMessageDialog(rootPane,"La imagen debe ser de 1500 x 1500 pixeles");
            chooser.setAcceptAllFileFilterUsed(false);
            chooser.setFileFilter(filter);
            chooser.showOpenDialog(null);
            chooser.getSelectedFile().getPath();
            ImageIcon imagen2 = new ImageIcon(chooser.getSelectedFile().getPath());
            if (imagen2.getIconHeight() <= 1500 && imagen2.getIconWidth() <= 1500) {
                ...
                JOptionPane.showMessageDialog(rootPane,"Te pasaste de los 1500 pixeles");
            }
                ...
                if (precioEstampa == -1) {
                    ...
                    if (imagen != null) {
                        ...
                        if (a == JOptionPane.YES_OPTION) {
                            d1.registrarEstampa(tipoEstampa, nombreEstampa, Ingreso.usuarioActivo, precioEstampa, imagen);
