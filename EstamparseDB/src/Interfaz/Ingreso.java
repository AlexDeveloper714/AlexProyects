...
public class Ingreso extends javax.swing.JFrame {
    ...
    DatosRegistro revisarIngreso = new DatosRegistro();
    ...
    public Ingreso() {
        ...
        revisarIngreso.crearTablas();
        revisarEstampa.ObtenerCategoria();
        if (!revisarIngreso.revisarDatos("a")
                && !revisarIngreso.revisarDatos("b")
                && !revisarIngreso.revisarDatos("c")) {
            revisarIngreso.registrarUsuariosDefecto();
        }
        if (!revisarIngreso.verificarTablaVacia()) {
            revisarIngreso.registrarTallasDefecto();
        }
        datosCompra.SeteoDescuentoSistema();
    ...
    private void botonIngresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIngresoActionPerformed
        ...
        if (!revisarIngreso.ingresarUsuario(usuario, contraseña)) {
            ...
            switch (DatosRegistro.TipoUsuario) {
                case "Cliente":
                    dispose();
    ...
    private void botonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalirActionPerformed
        ...
        if (a == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(null, "Gracias por ingresar a nuestra aplicación,"
                    + "\nesperamos haber satisfecho sus necesidades :D");
            System.exit(0);
        }
