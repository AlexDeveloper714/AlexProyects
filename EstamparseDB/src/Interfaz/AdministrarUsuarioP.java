...
DatosRegistro eliminar = new DatosRegistro();
...
//        Registro eliminar = new Registro();
        if (!userName.equals("")) {
            int a = JOptionPane.showConfirmDialog(null, "¿Deseas eliminar al " + tipousuario + " : "
                    + userName + " del sistema?");
            if (a == JOptionPane.YES_OPTION) {
                Boolean quitar = eliminar.elmininarUsuarios(userName, tipousuario);
                if (quitar) {
                    JOptionPane.showMessageDialog(rootPane, "Se elimino el " + tipousuario + " que busco");
                } else {
                    JOptionPane.showMessageDialog(rootPane, "No hay " + tipousuario + " a eliminar");
                }
            }
        } else {
