...
public class AdministrarCamisaP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SeleccionBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Color", "Talla", "Tipo Camiseta" }));
    ...
    private void AgregarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarBtnActionPerformed
        ...
        if (!"".equals(Info)) {
            if (c1.VerificarSeleccionOculta(Info, seleccion) != true) {
                if (c1.VerificarSeleccion(Info, seleccion) != true) {
                    int confirmacionCompra = JOptionPane.showConfirmDialog(null,
                            "¿Estas seguro de agregar la " + seleccion
                            + " el cual el valor es: " + Info + " ?");
                    if (confirmacionCompra == JOptionPane.YES_OPTION) {
                        c1.almacenarCamisas(Info, seleccion);
                        JOptionPane.showMessageDialog(rootPane, "Tus datos ya fueron agregados...");
                        TipoCamisetaTxt.setText("");
                    }

                } else {
                    JOptionPane.showMessageDialog(rootPane, "Sus datos ya existen en el sistema");
                    TipoCamisetaTxt.setText("");
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Sus datos estan ocultos en el sistema");
                TipoCamisetaTxt.setText("");
            }
        } else {
    ...
    private void OcultarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OcultarBtnActionPerformed
        ...
        if (!"".equals(Info)) {
            if (rootPaneCheckingEnabled) {
                ...
                if (confirmacionCompra == JOptionPane.YES_OPTION) {
                    if (c1.VerificarSeleccion(Info, seleccion) == true) {
                        c1.OcultarSeleccion(Info, seleccion);
    ...
    private void RestarurarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RestarurarBtnActionPerformed
        ...
        if (!"".equals(Info)) {
            if (rootPaneCheckingEnabled) {
                ...
                if (confirmacionCompra == JOptionPane.YES_OPTION) {
                    if (c1.VerificarSeleccionOculta(Info, seleccion) == true) {
                        c1.RestaurarSeleccion(Info, seleccion);
